  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 font-sans">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-teal-50 border border-teal-200/80 text-teal-800 rounded-full text-xs font-bold mb-4 shadow-sm">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight leading-tight mb-4">
          Fixing the <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-emerald-600">Disability-as-Fraud</span> Paradox in Digital Banking
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <button
            ...
            className="px-6 py-3 rounded-2xl bg-teal-600 hover:bg-teal-500 text-white font-bold text-sm shadow-lg shadow-teal-600/25 transition-all flex items-center gap-2 active:scale-98"
          >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 text-white mb-12 shadow-2xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-950/70 border border-slate-800 rounded-2xl p-4 flex flex-col justify-between">
            <div>
              <div className="w-8 h-8 rounded-xl bg-red-500/20 text-red-400 flex items-center justify-center font-bold text-xs mb-3">
                01
              </div>
              <h3 className="font-bold text-sm text-slate-200 mb-1">The Victim Site</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Open <strong className="text-red-300">/dummy-bank</strong>. Log in and trigger 3 failed OTPs or click "Simulate Tremor" to witness the hostile account lock.
              </p>
            </div>
            <button
              onClick={() => setCurrentRoute('/dummy-bank')}
              className="mt-4 text-xs text-red-400 hover:text-red-300 font-bold flex items-center gap-1"
            >
          ...
          <div className="bg-slate-950/70 border border-slate-800 rounded-2xl p-4 flex flex-col justify-between">
            <div>
              <div className="w-8 h-8 rounded-xl bg-teal-500/20 text-teal-300 flex items-center justify-center font-bold text-xs mb-3">
                02
              </div>
              <h3 className="font-bold text-sm text-slate-200 mb-1">15s Baseline Calibration</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Open <strong className="text-teal-300">/trust-layer</strong>. Tap 5 target discs to calibrate the user's tremor envelope and generate the Ed25519 token.
              </p>
            </div>
            <button
              onClick={() => setCurrentRoute('/trust-layer')}
              className="mt-4 text-xs text-teal-400 hover:text-teal-300 font-bold flex items-center gap-1"
            >
          ...
          <div className="bg-slate-950/70 border border-slate-800 rounded-2xl p-4 flex flex-col justify-between">
            <div>
              <div className="w-8 h-8 rounded-xl bg-emerald-500/20 text-emerald-300 flex items-center justify-center font-bold text-xs mb-3">
                04
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Victim Card */}
        <div className="bg-white border-2 border-red-200/80 rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-center mb-4">
              <div className="w-12 h-12 rounded-2xl bg-red-50 text-red-600 flex items-center justify-center">
                <ShieldAlert className="w-6 h-6" />
              </div>
              <span className="px-3 py-1 bg-red-100 text-red-800 text-[10px] font-bold uppercase rounded-full tracking-wider">
                Unprotected Legacy
              </span>
            </div>

            <h3 className="text-xl font-bold text-slate-900 mb-2">The Problem: Unprotected Bank Portal</h3>
          ...
          <button
            onClick={() => setCurrentRoute('/dummy-bank')}
            className="w-full mt-6 py-3 bg-red-50 hover:bg-red-100 text-red-700 border border-red-300 rounded-2xl font-bold text-xs flex items-center justify-center gap-2 transition-colors"
          >
        ...
        {/* Trust Layer Card */}
        <div className="bg-white border-2 border-teal-300/80 rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col justify-between ring-2 ring-teal-500/10">
          <div>
            <div className="flex justify-between items-center mb-4">
              <div className="w-12 h-12 rounded-2xl bg-teal-50 text-teal-600 flex items-center justify-center">
                <ShieldCheck className="w-6 h-6" />
              </div>
              <span className="px-3 py-1 bg-teal-100 text-teal-800 text-[10px] font-bold uppercase rounded-full tracking-wider">
                Full Trust Layer
              </span>
            </div>

            <h3 className="text-xl font-bold text-slate-900 mb-2">The Solution: Accessibility Trust Layer</h3>
            <p className="text-xs text-slate-600 mb-6 leading-relaxed">
          ...
          <button
            onClick={() => setCurrentRoute('/trust-layer')}
            className="w-full mt-6 py-3 bg-teal-600 hover:bg-teal-500 text-white rounded-2xl font-bold text-xs flex items-center justify-center gap-2 transition-all shadow-md shadow-teal-600/20"
          >
