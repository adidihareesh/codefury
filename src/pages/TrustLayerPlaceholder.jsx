...
export default function TrustLayerPlaceholder({ setCurrentRoute }) {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 text-center">
      <div className="w-16 h-16 rounded-2xl bg-teal-50 text-teal-600 flex items-center justify-center mx-auto mb-4 border border-teal-200 shadow-sm">
        <Sparkles className="w-8 h-8 animate-pulse" />
      </div>
      <span className="px-3 py-1 bg-teal-100 text-teal-800 text-xs font-bold rounded-full uppercase tracking-wider">
        Ready for Next Phase
      </span>
      <h2 className="text-2xl font-extrabold text-slate-900 mt-3 mb-2">Accessibility Trust Layer App</h2>
      <p className="text-slate-600 text-sm max-w-lg mx-auto mb-6">
        Phase 0 is currently active on <span className="font-mono font-bold text-red-600">/dummy-bank</span>. Confirm Phase 0 to unlock Phase 1 (Fintech dashboard baseline form).
      </p>
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 text-left max-w-md mx-auto mb-6 shadow-sm">
        ...
        <div className="space-y-2 text-xs">
          ...
          <div className="p-2 bg-slate-50 border border-slate-200 rounded text-slate-500">
      ...
      <button
        ...
        className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-xs font-bold inline-flex items-center gap-2 shadow"
      >
